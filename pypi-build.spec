...
Source0  : https://files.pythonhosted.org/packages/ce/9e/2d725d2f7729c6e79ca62aeb926492abbc06e25910dd30139d60a68bcb19/build-1.2.1.tar.gz
...
%prep
%setup -q -n build-1.2.1
cd %{_builddir}/build-1.2.1
pushd ..
cp -a build-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711726118
