...
Source0  : https://files.pythonhosted.org/packages/dd/bb/4a1b7e3a7520e310cf7bfece43788071604e1ccf693a7f0c4638c59068d6/build-1.2.2.tar.gz
...
%prep
%setup -q -n build-1.2.2
cd %{_builddir}/build-1.2.2
pushd ..
cp -a build-1.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725896060
