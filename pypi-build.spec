...
Source0  : https://files.pythonhosted.org/packages/7d/46/aeab111f8e06793e4f0e421fcad593d547fb8313b50990f31681ee2fb1ad/build-1.2.2.post1.tar.gz
...
%prep
%setup -q -n build-1.2.2.post1
cd %{_builddir}/build-1.2.2.post1
pushd ..
cp -a build-1.2.2.post1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729035252
